...
<body onload='loadHtml("side", "studentSidebar.html")'>
	...
	<table style = "margin-left: auto; margin-right: auto">
		...
		String student_email = ses.getAttribute("email").toString();
		...
		try {
			...
			String sql = "select registration_number from thesismanagement.student where email = '" + student_email + "'";
			ResultSet res = statement.executeQuery(sql);
			
			while (res.next()) {
				registration_number = res.getString("registration_number");
			}
		}
		catch (Exception e) {
			e.printStackTrace();
		...
		try {
			...
			String sql = "select * from thesismanagement.appointments where registration_number = '" + registration_number + "'";
			ResultSet res = statement.executeQuery(sql);
