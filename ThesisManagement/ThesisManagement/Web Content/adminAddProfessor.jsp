...
<body onload='loadHtml("side", "adminSidebar.html")'>
	...
	<div class="wrapper">
		...
		<div align="center">
		<h3>Enter the professor's data below</h3>
		<form action="<%=request.getContextPath()%>/Register" method="post">
			<table>
				...
				<tr>
					<td><input type="text" name="office_address" placeholder="Office Address" /></td>
				</tr>
				<tr>
					<td><input type="text" name="specialty" placeholder="Specialty" /></td>
				</tr>
			</table>
			<input type="hidden" name="jsp_name" value="adminAddProfessor" />
