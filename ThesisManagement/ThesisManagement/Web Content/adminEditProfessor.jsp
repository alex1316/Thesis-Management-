...
<body onload='loadHtml("side", "adminSidebar.html")'>
	...
	<div class="wrapper">
		...
		<div align="center">
			...
			<table>
				<tr>
					<td><input type="hidden" name="jsp_name" value="adminEditProfessor" /></td>
				</tr>
				<tr>
				...
				<tr>
					<td><input type="text" name="office_address" value=<%=resultSet.getString("office_address")%> /></td>
				</tr>
				<tr>
					<td><input type="text" name="specialty" value=<%=resultSet.getString("specialty")%> /></td>
				</tr>
				<tr>
				<td>
